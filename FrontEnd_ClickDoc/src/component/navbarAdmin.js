                    ...
                    <div class="menu-sidebar">
                        <div id="nav_menu-2" class="sidebar-widget  widget_nav_menu">
                            <div class="menu-menu-partie-gauche-container">
                                <Navbar.Brand href="/public/admin">Admin</Navbar.Brand>
                            </div>
                        </div>
                    </div>
                    <img src={logo}
                    ...
                    <Navbar expand="lg" >
                        ...
                        <Navbar.Collapse id="basic-navbar-nav">
                            ...
                            <Nav className="mr-auto ">
                                <Nav.Link href="/public/admin">Accueil</Nav.Link>
                                <Nav.Link href="/public/authentification-admin">Login</Nav.Link>
                                <Nav.Link href="/public/inscription-admin">Inscription</Nav.Link>
                            </Nav>
